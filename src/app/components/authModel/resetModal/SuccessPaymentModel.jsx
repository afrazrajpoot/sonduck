  ...
  return (
    <div>
      ...
      >
        <Box sx={style}>
          <figure>
            <img src="/img/successPayment.png" alt="success" className="rounded-t-lg" />
          </figure>
          <Typography
          ...
          <Link href={"/subscriptions"} className="w-full flex justify-center">
            <Button
              href="/subscriptions"
              // onClick={() => navigate.push("/store")}
              variant="outlined"
              className="mt-[2.5vw] p-[1vw] font-medium"
              sx={{
                mt: 2,
                borderColor: "#FF387A",
                color: "#FF387A",
