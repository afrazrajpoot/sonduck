      ...
      <div className="lg:translate-y-[8vw] sm:translate-y-[8vw] translate-y-[25vw]  lg:pb-[15vw] pb-[30vw]">
        <section>
          ...
          <article className="w-full max-w-[90vw] sm:gap-[5vw] mt-[4vw] flex flex-col gap-[3vw] lg:gap-[1vw] px-[9vw]">
            {refundData?.map((item, index) => (
              <p key={index} className="lg:text-[1vw] text-[4vw]  w-[85vw] sm:text-[2.5vw]">
                {item.info}
              </p>
            ))}
        ...
        <section className=" w-full max-w-[90vw] sm:gap-[5vw] flex flex-col gap-[3vw] lg:gap-[1vw] px-[9vw]">
          <article>
            ...
            <ul className="list-decimal pl-[2vw]">
              <li className="lg:text-[1vw] text-[4vw]  w-[85vw] sm:text-[2.5vw]">
                There is a clear and unsolvable problem within 30 days of your purchase. Proof must
                be sent that you have followed our support instructions.
              </li>
              <li className="lg:text-[1vw] text-[4vw]  w-[85vw] sm:text-[2.5vw]">
          ...
          <article>
            ...
            <ul className="list-decimal pl-[2vw]">
              {refundLi[0]?.map((item, index) => (
                <li key={index} className="lg:text-[1vw] text-[4vw]  w-[85vw] sm:text-[2.5vw]">
                  {item}
                </li>
              ))}
            </ul>
          ...
          <article>
            ...
            <ul className="list-decimal pl-[2vw]">
              <li className="lg:text-[1vw] text-[4vw]  w-[85vw] sm:text-[2.5vw]">
                There is a clear and unsolvable problem within 3 days of activating your Token for
                the first time. Proof must be sent that you have followed our support instructions.
              </li>
            </ul>
          </article>
          <article>
          ...
          <p className="lg:text-[1vw] text-[4vw]  w-[85vw] sm:text-[2.5vw]">
            By purchasing from our website, www.sonduckfilm.com you agree to our Returns & Refunds
            policy. We have the right to deny service if a user abuses our support or refund policy.
          </p>
        </section>
      </div>
      <footer>
